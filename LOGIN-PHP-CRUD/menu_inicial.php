...
<nav class="navbar navbar-default navbar-expand-lg navbar-light">
	<div class="navbar-header d-flex col">
		<a class="navbar-brand" href="#">Tommy<b>Hilfliger</b></a>  		
	...
	<div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
		<ul class="nav navbar-nav">
			<li class="nav-item"><a href="https://www.instagram.com/" class="nav-link">Home</a></li>
			<li class="nav-item"><a href="https://www.instagram.com/" class="nav-link">About</a></li>			
		...
		<ul class="nav navbar-nav navbar-right ml-auto">			
			<li class="nav-item">
				<a href="http://localhost/aula/index.php"/>Login</a>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="lewis.jpg" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img src="gigi.jpg" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img src="lewis.jpg" alt="New york" style="width:100%;">
      </div>
    </div>
